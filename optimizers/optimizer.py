...
class Optimizer:
    def __init__(self, model, loss, lr0, momentum, weight_decay, warmup_steps, warmup_start_lr, max_iter, power, *args, **kwargs):
        ...
        loss_nowd_params = loss.boundary_loss_func.get_params()
        ...
        self.optim = torch.optim.SGD(param_list, lr=lr0, momentum=momentum, weight_decay=weight_decay)
