...
from models.backbones.stdc_net import STDCNet1446, STDCNet813
from models.abn import ABN as BatchNorm2d


class ConvBNReLU(nn.Module):
    def __init__(self, in_planes, out_planes, ks=3, stride=1, padding=1, *args, **kwargs):
        super(ConvBNReLU, self).__init__()
        self.conv = nn.Conv2d(in_planes, out_planes, kernel_size=ks, stride=stride, padding=padding, bias=False)
...
class BiSeNetOutput(nn.Module):
    def __init__(self, in_planes, mid_planes, n_classes, *args, **kwargs):
        super(BiSeNetOutput, self).__init__()
        self.conv = ConvBNReLU(in_planes, mid_planes, ks=3, stride=1, padding=1)
        self.conv_out = nn.Conv2d(mid_planes, n_classes, kernel_size=1, bias=False)
        self.init_weight()
...
class AttentionRefinementModule(nn.Module):
    def __init__(self, in_planes, out_planes, *args, **kwargs):
        ...
        self.conv = ConvBNReLU(in_planes, out_planes, ks=3, stride=1, padding=1)
        self.conv_atten = nn.Conv2d(out_planes, out_planes, kernel_size=1, bias=False)
        self.bn_atten = BatchNorm2d(out_planes, activation='none')
...
class FeatureFusionModule(nn.Module):
    def __init__(self, in_planes, out_planes, *args, **kwargs):
        ...
        self.convblk = ConvBNReLU(in_planes, out_planes, ks=1, stride=1, padding=0)
        self.conv1 = nn.Conv2d(out_planes, out_planes // 4, kernel_size=1, stride=1, padding=0, bias=False)
        self.conv2 = nn.Conv2d(out_planes // 4, out_planes, kernel_size=1, stride=1, padding=0, bias=False)
...
class BiSeNet(nn.Module):
    def __init__(self, backbone, n_classes, pretrain_model='', use_boundary_2=False, use_boundary_4=False, use_boundary_8=False, use_boundary_16=False, use_conv_last=False, *args, **kwargs):
